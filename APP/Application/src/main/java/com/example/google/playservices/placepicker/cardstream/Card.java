...
public class Card {
    ...
    public Card setImage(Bitmap image) {
        if (mImageView != null) {
            mImage = image;
    ...
    public static class Builder {
        ...
        public Card build(Activity activity) {
            ...
            View viewImage = cardView.findViewById(R.id.card_image);
            if (mCard.mImage != null && viewImage != null) {
                mCard.mImageView = (ImageView) viewImage;
                mCard.mImageView.setImageBitmap(mCard.mImage);
